...
<div class="CSSTableGenerator"> 
  <table align="center">
    <tr> 
      <td colspan="2" align="center">View Comments</td>
    </tr>
    <tr> 
      <td><img  src="images/comments.jpg" width="296" height="211"></td>
      <td> <table align="center" class="item dinner"
		 >
          <tr> 
            <td colspan="3" align="center" >Comments Page</td>
          </tr>
          <tr> 
            <td><font color="#990099" size="4"><strong>Customer_Name</strong></font></td>
            <td><font color="#990099" size="4"><strong>Ordered Items</strong></font></td>
            <td><font color="#990099" size="4"><strong>Comments</strong></font></td>
          </tr>
          <%	
...
String customer_name=(String)session.getAttribute("name");
	...
	ResultSet rs = st.executeQuery("SELECT * FROM voucher ");
          ...
          <tr> 
            ...
            <td style="padding:10px;padding-right:0px;"><%=items%> </td>
            <td style="padding:10px;padding-right:0px;"><%=comments%> </td>
