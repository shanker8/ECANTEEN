...
JFreeChart chart = ChartFactory .createBarChart3D("Food Items", "count", "Price($)",dataset, PlotOrientation.VERTICAL, true, true, false);
...
<div class="CSSTableGenerator"> 
  <table width="363" height="200" align="center">
    <tr>
      <td colspan="2" align="center">Chart View Page</td>
    </tr>
    <Tr>
      <td><img src="images/chart1.jpg"></td>
