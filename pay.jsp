...
<div class="CSSTableGenerator"> 
  <table align="center">
    <tr> 
      <td colspan="2" align="center">Customer Bill Payment Page</td>
    </tr>
    <tr> 
      <td><img src="images/pay.png"></td>
      <td> <table align="center" class="item dinner"
		 >
          <tr> 
            <td colspan="4" align="center">Payment Page</td>
          </tr>
          <tr> 
            <td height="25"><font color="#000099" size="3"><strong>Customer_Name</strong></font></td>
            <td> <font color="#000099" size="3"><strong>Ordered Items</strong></font></td>
            <td><font color="#000099" size="3"><strong>Provide Service</strong></font></td>
			 <td><font color="#000099" size="3"><strong>Click Here</strong></font></td>
          </tr>
          <%	
...
String customer_name=(String)session.getAttribute("name");
	...
	ResultSet rs = st.executeQuery("SELECT * FROM voucher where customer_name='"+customer_name+"' AND order_status='"+h+"'" );
				while(rs.next())
				{
					//int s=rs.getInt("sno");
					//String pname=rs.getString("pname");
					String customer_name1=rs.getString("customer_name");
				...
				String price=rs.getString("total_price");
					 %>
          <tr> 
            <td style="padding:10px;"> <strong><font color="#660033" size="3"><%=customer_name1%></font></strong> </td>
            <td style="padding:10px;padding-right:0px;"><%=ap%> </td>
			  <td style="padding:10px;padding-right:0px;">$<%=price%> </td>
            <td><a href="pay1.jsp?ad=<%=customer_name1%>,<%=items%>">Pay_Bill Here 
              </a></td>
          </tr>
          <%
	   					}
