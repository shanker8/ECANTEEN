    ...
    <span class="icon-bar"></span> <span class="icon-bar"></span> </button>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav main-nav  clear navbar-right ">
                    <li><a class="active color_animation" href="index.html">Home</a></li>
...
<div class="CSSTableGenerator"> 
  <form action="test.jsp" method="get"><table align="center">
    <tr>
      <td colspan="2" align="center">Select Here</td>
    </tr>
    <tr>
      <td><img src="images/user_perspective.png"></td>
      <td><table width="352" height="117">
          
		  <tr><td width="198"><a href="view_items.jsp">View Items</a></td></tr>
		  <tr><td><a  href="order_items.jsp">Order Items</a></td></tr>
		  <tr><td><a href="v.jsp">View Items</a></td></tr>
		  
		  <tr><td><a href="pay.jsp">View Bill and Payment mode</a></td></tr>
