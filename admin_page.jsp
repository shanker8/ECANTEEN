...
<body>
        ...
        <!-- Brand and toggle get grouped for better mobile display -->
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav main-nav  clear navbar-right ">
                    <li><a class="active color_animation" href="admin_login.jsp">Home</a></li>
 ...
 <section id="reservation" class="background_content">
        ...
        <table width="363" height="200" align="center">
		<tr><td colspan="2" align="center">Chart View Page</td></tr>
		
		<Tr><td><img src="images/admin.png"></td><td>
		<table width="300" height="300">
		<tr><td>Click Here</td></tr>
		 <tr><td><a href="upload_item.jsp">Upload Item Details</a></td></tr>
		<tr><td><a href="view_comments.jsp">View Comments</a></td></tr>
		
        <tr><td><a href="chart_view.jsp">View Chart</a></td></tr>
		 <tr><td><a  href="samples/chart.html">View Chart1</a></a></td></tr>
		 <tr><td><a  href="logout.jsp">Logout</a></a></td></tr>
