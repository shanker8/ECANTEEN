...
<div class="CSSTableGenerator"> 
  <table align="center">
    <tr> 
      <td colspan="2" align="center">Customer Page</td>
    </tr>
    <tr> 
      <td><img src="images/stu_login.gif"></td>
      <td> <table align="center" class="item dinner"
		 >
          <tr>
            <td colspan="2" align="center" >Ordered Items</td>
          </tr>
          <tr>
            <td><font color="#FF0099" size="4"><strong>Customer_Name</strong></font></td>
            <td><font color="#FF0099" size="4"><strong>Ordered Items</strong></font></td>
            <td><font color="#FF0099" size="4"><strong>Provide Service</strong></font></td>
          </tr>
...
String customer_name=(String)session.getAttribute("name");
	...
	ResultSet rs = st.executeQuery("SELECT * FROM voucher where customer_name='"+customer_name+"'");
				while(rs.next())
				{
					//int s=rs.getInt("sno");
          ...
          <tr> 
            ...
            <td><a href="view_images.jsp?ap=<%=ap%>">View_Images 
              </a></td>
          </tr>
          <%
	   					}
