...
<body>
 ...
 <section id="reservation" class="background_content">
		...
		<form action="logincheck.jsp" method="get">
               <table align="center">
 <tr><td colspan="2" align="center">Customer Login Here</td></tr>
 <tr><td><img src="images/stu_login.gif"></td> 
 <td><table><tr><td colspan="2" align="center">Click Here</td></tr>
 <tr><td>Customer Name</td>
 <td><input type="text" name="name"></td></tr>
 <tr><td>Password</td><td>
 <input type="password" name="pass"></td></tr>
 <tr><td colspan="2" align="center"><input type="submit" value="Login" ></td></tr>
 <tr><td colspan="2" align="center"><a href="register.jsp">New User Signup Here</a></td></tr>
